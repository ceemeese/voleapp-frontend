...
<template>
    <BaseCard class="!min-w-70 !w-70 !p-0 !shadow-sm hover:!shadow-xl hover:border-[#C8E794] transition-all duration-300 group cursor-pointer overflow-hidden h-full relative">
